...
<head>
<meta charset="utf-8">
<title>Educa Rurale - Lista de Professores</title>
	...
	<div class="container">
		<div class="row">
			<div class="cold-md-7">
				...
				<hr>
				<form action="CreateProfessor" method="GET" class="d-flex">
					...
					<tbody>
						<c:forEach items="${professores}" var="professor">
							<tr>
								...
								<td><a
									href="DProfessor?professorid_pro=${professor.id_pro}"><button
											class="btn-danger">DELETAR</button></a></td>
								<td><a
									href="AtuProfessor?professorid_pro=${professor.id_pro}"><button
											class="btn-success">ATUALIZAR</button></a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
				<a href="cadastro_professor.html"><button class="btn btn-theme">VOLTAR
						PARA CADASTRO DE PROFESSORES</button></a>
			</div>
		</div>
	</div>
